...
# Ejecutar script
\i scripts/create_supabase_database.sql
```

#### Opción C: Desde pgAdmin

1. Conectar a la base de datos de Supabase
2. Abrir Query Tool
3. Cargar y ejecutar `create_supabase_database.sql`
...
\i scripts/verify_supabase_database.sql
```

O copiar y pegar el contenido de `verify_supabase_database.sql` en el SQL Editor.
...
Actualizar `settings.py` para usar SSL:
